...
import { ChevronDown, LogOut, User, Menu, X, BookOpen } from "lucide-react";

export default function StudentNavbar({ sidebarOpen, setSidebarOpen }) {
      ...
      <div className="relative flex items-center gap-3" ref={dropdownRef}>
        ...
        >
          <span className="hidden text-[15px] text-[#494949] sm:inline">
            Hi! <span className="font-medium text-[#252525]">Student</span>
          </span>
          <div className="relative flex h-[45px] w-[45px] items-center justify-center overflow-hidden rounded-full bg-[#D62A91]/10 shadow-[0_4px_4px_rgba(0,0,0,0.05)]">
            <BookOpen size={20} className="text-[#D62A91]" />
          </div>
